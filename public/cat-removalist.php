...
?>
 ...
 <div id="content300w" style="background: url(images/cats/House_Office_Removals.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 157px;">
				<h1 class="banner">Removalist Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(6); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					...
					<span class="pl"><p class="pl">List what you need moved for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
                ...
                <span class="pl"><p class="pl">Receive moving quotes from moving companies online.</p></span>
				</div>
				...
				<span class="pl"><p class="pl">	Read ratings and reviews of movers from previous customers to make the right choice.</p></span></div>
				<div id="how4_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">4</span><span style="font-size: 12.5pt;" > <span style="font-size: 12.1pt;pt;">Select a Transporter</span></span></h2>
				<span class="pl"><p class="pl">	Select a removalist that matches your needs and budget. There's no obligations!
				No Calls!</p></span></div>
			</div>
 <div class="clear"></div>
 <div id="index-bottom">
		...
		jQuery(document).ready(function($) {
		   ...
		   $(function(){$(".val1").geocomplete();
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml">Why should I use Freightmeta to find a removalist?</h2>
					</div>
					<div style="font-size: 8pt;">
						<div style="margin-bottom:6px;">
							...
							<strong>Save Money</strong>- By comparing multiple removal quotes you can be assured your getting a great deal.
							<div class="clear"></div>
						</div>
