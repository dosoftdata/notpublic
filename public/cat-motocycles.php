...
?>
 ...
 <div id="content300w" style="background: url(images/cats/Motorcycle.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 83px;">
				<h1 class="banner">Motorcycle Transport Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(3); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12.5pt;"> List Your Motorcycle</span></h2>
					<span class="pl"><p class="pl">List your motorcycle for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
                ...
                <span class="pl"><p class="pl">Receive competitive quotes from bike transporters online without the need to phone around.</p></span>
				</div>
 ...
 <div class="fl" style="font-size:9pt;width:520px; border-right:1px dotted #cccccc; padding-right:20px; margin-left:10px;">
					...
					<div style="margin-bottom:6px;">
						<h2 class="sml">More about shipping your Motorbike with Freighmeta</h2>
					</div>
		...
		jQuery(document).ready(function($) {
            ...
            $(function(){$(".val1").geocomplete();
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml" style="font-size: 8pt;">Why should I use Freightmeta to help me ship my Motorbike?</h2>
					</div>
					<div style="font-size: 8pt;">
						<div style="margin-bottom:6px;">
							...
							<strong>Save Money</strong>- Motorcycle Transporters compete against each other in a public marketplace driving down prices.
							<div class="clear"></div>
						</div>
