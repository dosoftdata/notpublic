...
?>
 ...
 <div id="content300w" style="background: url(images/cats/Hay_Grain_Feed.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 159px;">
				<h1 class="banner">Hay Transport Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(14); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12pt;"> List Your Hay / Grain</span></h2>
					<span class="pl"><p class="pl">List your hay, grain or feed for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
				<div id="how2_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
                 ...
                 <span class="pl"><p class="pl">Receive hay transportation quotes from hay transporters online.</p></span>
				</div>
				<div id="how3_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					...
					<span class="pl"><p class="pl">Read reviews of hay transporters from previous customers to make the right choice.</p></span></div>
				<div id="how4_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					...
					<span class="pl"><p class="pl">Select a hay transporter that matches your needs and budget. There's no obligations!
				No Calls!</p></span></div>
			</div>
 <div class="clear"></div>
 <div id="index-bottom">
 <div class="fl" style="font-size: 9pt;width:520px; border-right:1px dotted #cccccc; padding-right:20px; margin-left:10px;">
					...
					<div style="margin-bottom:6px;">
						<h2 class="sml">More about shipping your Hay with Freighmeta</h2>
					</div>
                    <p>When shipping hay it can be exhausting and frustrating trying to chase around hay transport companies for quotes. <a href="<?= Link::Build(''); ?>">Freightmeta.com</a> allows the customer to list what they need moved then just sit back and wait for quotes to come in. Customers then select a transporter based on reviews and a price that suits their budget. </p><p>Hay transporters compete for your business in the Freightmeta public marketplace driving down prices and can offer customers massive bargains as Freightmeta helps them to utilise the empty capacity in their trucks, especially when returning home from a delivery.</p><p>All quotes are online so you'll never receive any sales calls and your information is kept strictly private. You details are only provided to the transport provider you choose for the job. Freightmeta offers shipping customers and transport providers great online tools to manage the whole process with ease and best of all, It's a FREE service!</p><p>Whether you're a business with lots of regular hay bales, grain or feed to move, or an individual with a once off shipment, Freightmeta can save you a buck!<br />
      ...
      $.noConflict();
       ...
       $(function(){$(".val1").geocomplete();
					...
					<div style="margin-bottom:8px;font-size: 9px;">
						<h2 class="sml">Why should I use Freightmeta to find a hay?</h2>
					</div>
					<div style="font-size: 8pt;">
						...
						<div style="margin-bottom:6px;">
							...
							<strong>Save Money</strong> - Hay transporters compete against each other in a public marketplace driving down prices.
