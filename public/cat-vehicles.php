...
?>
 ...
 <div id="content300w" style="background: url(images/cats/Vehicles_Transport.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 125px;">
				<h1 class="banner">Vehicle Transport Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(1); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:20=px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12.5pt;"> List Your Cars </span></h2>
						<span class="pl"><p class="pl">List your vehicle(s) for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
				<div id="how2_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">2</span><span style="font-size: 12.5pt;"> Receive Quotes</span></h2>
						<span class="pl"><p class="pl">Receive freight  shipping quotes from transporters at discounted rates. Save upto 60%</p></span>
				</div>
				<div id="how3_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">3</span> <span style="font-size: 12.5pt;">Check Their Ratings</span></h2>
						<span class="pl"><p class="pl">Read ratings and reviews from previous car transport customers to make the right choice.</p></span></div>
				<div id="how4_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">4</span><span style="font-size: 12.5pt;" > <span style="font-size: 12.1pt;">Select a Transporter</span></span></h2>
					<span class="pl"><p class="pl">Select a car carrier that matches your needs and budget. There's no obligations!
				No Calls!</p></span></div>
			</div>
 <div class="clear"></div>
 <div id="index-bottom">
 <div class="fl" style="font-size: 9pt;;width:520px; border-right:1px dotted #cccccc; padding-right:20px; margin-left:10px;">
					...
					<div style="margin-bottom:6px;">
						<h2 class="sml">More about shipping your Car with Freighmeta</h2>
					</div>
								<p>When shipping cars interstate it can be exhausting and frustrating trying to chase around vehicle transport companies for quotes.  <a href="<?= Link::Build(''); ?>">Freightmeta.com</a> allows the customer to list their vehicle and and then simply wait for the quotes to come in. Customers then select a transporter based on reviews and a price that suits their budget. </p><p>Vehicle transporters compete for your business in the Freightmeta public marketplace. All quotes are online so you'll never receive any sales calls and your information is kept strictly private. You details are only provided to the transport provider you choose for the job. Freightmeta offers shipping customers and transport providers great online tools to manage the whole process with ease and best of all, It's a FREE service!</p><p>Whether you're a business with lots of regular cars to move, or an individual with a once off shipment, Freightmeta can save you a buck!<br />
       ...
       $(function()
           ...
           $(".val2").geocomplete();
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml">Why should I use Freightmeta to help me ship my Car?</h2>
					</div>
					<div style="font-size: 7.7pt;">
						<div style="margin-bottom:6px;">
							<div class="left" style="width:20px;height:20px;">
								<img src="images/gen/tick.gif" />
							</div>
							<strong>Save Money</strong> - Freightmeta gives transporters the opportunity to fill their empty space and that means you can get great deals!<div class="clear"></div>
						</div>
