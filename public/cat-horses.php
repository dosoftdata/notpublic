...
?>
 ...
 <div id="content300w" style="background: url(images/cats/horses2.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			...
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 139px;">
				<h1 class="banner">Horse Transport Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(9); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12.5pt;"> List Your Horses</span></h2>
					<span class="pl"><p class="pl">List your horse for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
                ...
                <span class="pl"><p class="pl">Receive Horse transport quotes from horse transporters at heavily discounted rates.</p></span>
				</div>
				<div id="how3_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					...
					<span class="pl"><p class="pl">Read reviews from previous horse transport customers to make the right choice.</p></span></div>
				...
				<span class="pl"><p class="pl">Select a Horse Transporter that matches your needs and budget. There's no obligations!
				No Calls!</p></span></div>
			</div>
 <div class="clear"></div>
 <div id="index-bottom">
			...
			$('.fm_tvideo').fancybox(
             ...
             $(function(){$(".val1").geocomplete();
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml">Why should I use Freightmeta to help me ship my Horse?</h2>
					</div>
					<div style="font-size: 8pt;">
						<div style="margin-bottom:6px;">
							...
							<strong>Save Money</strong>- Horse Transporters compete against each other in a public marketplace driving down prices.
							<div class="clear"></div>
						</div>
