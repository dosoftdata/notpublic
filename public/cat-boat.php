...
?>
 ...
 <div id="content300w" style="background: url(images/cats/boat.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px; left: 130px;">
				<h1 class="banner">Boat and Yacht Shipping Quotes</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(4); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12.5pt;"> List Your Boat</span></h2>
					<span class="pl"><p class="pl">List your boat&nbsp;/&nbsp;yacht for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
				<div id="how2_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
                   ...
                   <span class="pl"><p class="pl">Receive Boat transport quotes from Boat transporters at heavily discounted rates.</p></span>
				</div>
				...
				<div id="how4_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					...
					<span class="pl"><p class="pl">Select a Boat Shipper that matches your needs and budget. There's no obligations!
				No Calls!</p></span></div>
			</div>
 <div class="clear"></div>
 <div id="index-bottom">
 <div class="fl" style="font-size:9pt;width:520px; border-right:1px dotted #cccccc; padding-right:20px; margin-left:10px;">
					...
					<div style="margin-bottom:6px;">
						<h2 class="sml">More about shipping your Boat with with Freighmeta</h2>
					</div>
		...
		jQuery(document).ready(function($) {
           ...
           $(".val2").geocomplete();}); 
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml">Why should I use Freightmeta to help me ship my Boat?</h2>
					</div>
