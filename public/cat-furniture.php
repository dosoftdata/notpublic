...
?>
 ...
 <div id="content300w" style="background: url(images/cats/furniture_transport.jpg) no-repeat;">
 <div style="">
 <div id="banner-arrow"><img class="ro2d30" src="images/gen/green-arrow-home.png" /></div>
			...
			<div id="banner-content" class="whitebg rounded5 opacity65" style="padding: 10px 10px 10px 10px;left: 125px;">
				<h1 class="banner">Freight Transport Quotes Online</h1>
				<h2 class="banner">
 ...
 <select id="categoryhomecat" class="fl" style=" position: relative;left: 30px;width: 375px; margin-top:0px ;"name="selectionField"> 
    ...
    fm_freight::load_freight_subcat_list(8); 
    ?>
 </select> 
...
<input class="input val2" class="fr" type="text" name="origin" placeholder="Destination address City, Country" value="" style="position: relative; left: 30px;width: 370px; right: 58px; margin-top: -2px;" id="inputdest" />
 ...
 <div class="fl btn_position" style="position: relative; margin-top: 55px; width: 100%; height: 44px; margin-left: -175px;">
 ...
 How It Works 
				...
				<div id="how1_v"style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">1</span><span style="font-size: 12.5pt;;"> List Your Freight</span></h2>
					<span class="pl"><p class="pl">List your freight for FREE. It's simple and takes less than 60 seconds!</p></span>
				</div>
                ...
                <span class="pl"><p class="pl">Receive freight shipping quotes from transporters at heavily discounted rates. Save upto 70%</p></span>
				</div>
				<div id="how3_v" style="background-color:#FFFFFF; padding:2px;" class="rounded">
					<h2><span class="bluebg rounded5">3</span> <span style="font-size: 12.5pt;t;">Check Their Ratings</span></h2>
					<span class="pl"><p class="pl">Read ratings and reviews from previous Boat transport customers to make the right choice.</p></span></div>
 ...
 <div class="fl" style="font-size:9pt;width:520px; border-right:1px dotted #cccccc; padding-right:20px; margin-left:10px;">
					...
					<div style="margin-bottom:6px;">
						<h2 class="sml">More about shipping your Freight with Freighmeta</h2>
					</div>
		...
		jQuery(document).ready(function($) {
		 ...
		 $(function(){$(".val1").geocomplete();
					...
					<div style="margin-bottom:8px;">
						<h2 class="sml">Why should I use Freightmeta to help me ship my Freight</h2>
					</div>
